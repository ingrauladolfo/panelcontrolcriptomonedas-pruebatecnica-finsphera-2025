...
export const Pagination: FC<PaginationProps> = ({ pages, currentPage, handlePageChange, itemsPerPage, handleItemsPerPageChange, itemsPerPageOptions, t }) => {
    return (
        <div className="flex flex-col sm:flex-row items-center mt-5 [@min-width:480px]:flex-row [@min-width:480px]:justify-between [@min-width:480px]:gap-2 [@min-width:480px]:w-full [@min-width:480px]:max-w-245 [@min-width:480px]:my-0 [@min-width:480px]:mx-auto">
            <div className="flex items-center mb-2.5 [@min-width:480px]:justify-center [@min-width:480px]:gap-2 [@min-width:480px]:mb-0">
            ...
            <div className="flex flex-col items-center my-0 mx-2.5 [@min-width:480px]:justify-between [@min-width:480px]:m-0">
                <label htmlFor="items-per-page" className="text-[#d1d1d1] text-[14px] mt-1.25">{t.rowPerPage}</label>
                <select id="items-per-page" className="m-2.5 p-2.5 border border-[#ccc] rounded-[5px] bg-[#333] text-[#d1d1d1] text-[16px] w-full h-10 overflow-y-auto [@min-width:480px]:w-25  [&>option:checked]:bg-[#d1d1d1] [&>option:checked]:text-[#333] dashboard-users-pagination-select" value={itemsPerPage} onChange={handleItemsPerPageChange}>
